...
def get_sam2_masks(image_filepath, pixel_x, pixel_y, sam_predictor, visualize=False):
    """
...
def visualize_sift_matches(
    ...
    if des_query is None or len(kp_query) == 0:
        print(f"No SIFT features found in query camera image: {query_cam.filepath}")
        return
